#!/usr/bin/env bash
# 一键脚本：在【本机 Linux】装 nyanpass nodeclient (yuwan) + 内核网络调优
...
# 例:
#   sudo -E bash <(curl -fsSL https://gh-proxy.com/https://raw.githubusercontent.com/inifcloud/inifcloudsh/main/yuwan.sh) 202.155.155.254 'wasd123yuwan/'
#
